...
const styles = StyleSheet.create({
  ...
  addForm: { marginHorizontal: 20, marginTop: 12, gap: 8, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.separator, borderRadius: 14, padding: 16 },
  inputRow: { flexDirection: "row", gap: 8 },
  input: { backgroundColor: colors.background, borderWidth: 1, borderColor: colors.separator, borderRadius: 10, padding: 12, fontSize: 14, color: colors.foreground },
